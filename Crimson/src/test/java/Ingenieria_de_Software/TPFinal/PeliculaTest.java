...
public class PeliculaTest {
    ...
    public void setup(){
        ...
        peliculaTest1 = new Pelicula("Aladdin", "Aventura Romantica", "ATP", "",sala1);
        peliculaTest2 = new Pelicula("Detective Pikachu", "Aventura", "ATP", "",sala2);
        peliculaTest3 = new Pelicula("Avengers Endgame", "Accion", "+13", "" ,sala3);
        peliculaTest4 = new Pelicula("John Wick 3", "Accion", "+16", "",sala4);
        peliculaTest5 = new Pelicula("Godzilla 2", "Ciencia Ficcion", "+13", "", sala5);
